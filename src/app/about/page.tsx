...
export default function AboutPage() {
    ...
    return (
        <main className="bg-white min-h-screen">
            ...
            <section className="w-full bg-white relative z-10 py-12 md:py-24 px-6 md:px-12">
                <div className="max-w-4xl mx-auto w-full">
                    <Reveal>
                        <div className="text-center mb-16">
                            <h1 className="text-[#1d1d1f] mb-4 text-5xl md:text-7xl font-bold tracking-tighter">L'ARTISAN</h1>
                    ...
                    <Reveal delay={0.2}>
                        <div className="w-full max-w-2xl mx-auto">
                            <div className="text-lg leading-loose text-gray-800 font-light tracking-wide text-left md:text-justify">
                                <p className="mb-8">
                                    <span className="text-5xl font-bold text-[#1d1d1f] mr-3 float-left leading-none mt-2 font-serif">F</span>
                                ...
                                <div className="my-12 pl-6 border-l-4 border-[#fca00b] py-4 bg-gray-50 rounded-r-lg">
                                ...
                                <div className="bg-gray-100 p-8 md:p-12 rounded-2xl my-16 shadow-sm">
                                    <h3 className="font-bold text-[#1d1d1f] text-center mb-8 text-sm uppercase tracking-[0.2em] font-sans">Aujourd’hui, FEELPROD est à la croisée de plusieurs mondes</h3>
                                    <ul className="space-y-4 text-center text-gray-700 font-medium text-lg list-none p-0">
                                ...
                                <div className="mb-20 text-center px-4">
                                    ...
                                    <p className="italic text-gray-500 font-light text-xl font-serif">aller chercher la lumière chez les personnes, la mettre en valeur, l’accompagner, l’immortaliser.</p>
                                </div>

                                <div className="text-center pt-12 border-t border-gray-200 mt-12 pb-12 w-full">
                                    <div className="inline-block text-center">
                                        <p className="text-3xl md:text-4xl font-bold text-[#1d1d1f] leading-tight font-sans tracking-tight mb-4">
                                            FEELPROD
                                        </p>
                                        <p className="text-xl text-gray-600 font-normal mb-2">c’est une vision sensible de l’image.</p>
                                        <p className="text-2xl text-gray-800 font-medium mb-2">Une attention portée au vivant.</p>
                                        <p className="text-2xl text-[#fca00b] font-bold uppercase tracking-widest mt-4">Une vie en mouvement.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
